...
class DictionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post dictionaries_url, params: { dictionary: { name: @dictionary.name, notes: @dictionary.notes } }
    end
  ...
  test "should update dictionary" do
    patch dictionary_url(@dictionary), params: { dictionary: { name: @dictionary.name, notes: @dictionary.notes } }
